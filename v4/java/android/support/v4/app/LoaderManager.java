...
public abstract class LoaderManager {
    ...
    /**
     * Same as initLoader except calling onLoaderFinished() if loader
     * has data
     *
     * @param id
     * @param args
     ...
     * @return
     */
    public abstract <D> Loader<D> reAttachLoader(int id, Bundle args,
            LoaderManager.LoaderCallbacks<D> callback);
...
class LoaderManagerImpl extends LoaderManager {
    ...
    @SuppressWarnings("unchecked")
    public <D> Loader<D> reAttachLoader(int id, Bundle args, LoaderManager.LoaderCallbacks<D> callback) {
        if (mCreatingLoader) {
            throw new IllegalStateException("Called while creating a loader");
        }
